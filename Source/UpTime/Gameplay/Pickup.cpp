	...
	: PickupDisplayName(TEXT(""))
{
	...
	CollisionSphere = CreateDefaultSubobject<USphereComponent>(TEXT("Pickup Collision"));
	...
	InteractMessageWidget = CreateDefaultSubobject<UWidgetComponent>(TEXT("Interact Message Widget"));
