...
void AProjectileWeapon::FireShot()
{
	...
	IArmedActor* WeaponOwner = Cast<IArmedActor>(ShotInstigator);
	...
	TArray<FVector> MuzzleLocations = IArmedActor::Execute_GetWeaponMuzzleLocations(ShotInstigator, MuzzleConfiguration);
